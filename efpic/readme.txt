=== efpic - Online Photo Proofing Gallery ===
Plugin Name: efpic – Online Photo Proofing Gallery
Plugin URI: https://efpic.io/
Contributors: efpic, florianziegler, pandulu
...
Take your photography business to the next level with [efpic](https://efpic.io/?utm_source=wordpress.org&utm_medium=readme) – the ultimate photo proofing solution for professional photographers. 

Create private photo galleries for clients and make online photo approval simple, accurate, and fast. All galleries are customizable, and proofing with efpic makes it easier than ever for both you and your clients.

### Introduction ###

Are you a professional photographer looking to improve the way you work with clients by streamlining your photo proofing process? Look no further than efpic – the comprehensive **WordPress photo proofing plugin**. 

Designed to make it quick and easy to create online client galleries – use efpic to let your clients make their preferred selections, and organize the entire workflow directly in WordPress so you can keep clients on the website you fully own & control.

*Prefer to see a 3 minute demo of how easy and effective using efpic is?*

Take a look at the video below for a complete walkthrough of the photo proofing process with efpic:

https://youtu.be/xyPFBdXHakI

### Why Photographers Choose efpic for their Client Approval Workflow ###

efpic is not just another plugin. It’s a whole new way of enabling clients to view and approve photos online. Free yourself up from endless admin, speed up project turnaround times, and delight your clients with an easy way to view, approve, and share feedback with you. 

Let’s take a closer look at exactly how efpic can help you with your photography business: 

**Effortless Client Approval**

It’s time to say goodbye to endless back-and-forth emails and switch to an approval workflow that makes it easy for both you and your clients. With efpic, you can share a link to photo galleries directly on your own website (not some third-party service) and make it effortless for your clients to browse and confirm their selections – as well as leave comments as they do so.

**Seamless Workflow**

The approval process with efpic is as easy as it gets. As soon as you’ve created your gallery, simply send an automated email to your clients or manually copy the link to share with them separately. This link will allow them to view their photos and make their selections. Once they approve a collection, you’ll receive an automatic email notification, so you’re always in the loop without the hassle of chasing clients up. 

**Integration with Your Workflow**

efpic seamlessly integrates with your existing photo management software. After your client approves a collection, you can easily retrieve their selections and incorporate them into your preferred workflow. Everything happens within the familiar environment of your WordPress website, making for a seamless photo proofing experience.

**Stunning, Theme-Independent Design**

efpic prides itself on its beautiful, theme-independent design for proofing collections. This ensures a consistent, user-friendly, and easy-to-understand workflow for your clients. But that's not all – efpic Pro takes it a step further by allowing you to customize the client photo gallery to match your branding, providing your clients with a personalized proofing experience that reinforces your professional image.

**Enhance Your Brand (Pro Only)**

With efpic Pro, you have the power to add your custom logo and tailor the appearance of your galleries to align with *your unique branding*. This level of customization distinguishes you from the competition, and leaves a lasting impression on your clients. 
...
Streamline image management with the *import* feature. Easily upload large quantities of images via FTP and import them to efpic directly from your web server. This completely removes the need for time-consuming manual uploads, making your workflow more efficient.

**Theft Protection (Pro Only)**

Protect your valuable images from theft with efpic Pro's *robust theft protection* measures. These measures include the ability to add watermarks to your uploads, along with other security features to ensure that your work remains secure.

**Multi-Client Support (Pro Only)**

efpic Pro's *multi-client support* is ideal for photographers who manage multiple clients. Send photo collections to multiple recipients and receive individual selections, ensuring a seamless and organized workflow.

**Priority Support (Pro Only)**

At efpic, we value our customers, and we're committed to providing exceptional support. efpic Pro offers *priority support via email* exclusively to Pro license holders. When you need assistance, you can count on prompt and personalized support to address your specific needs.

**Why Choose efpic?**

efpic is a WordPress plugin *designed for photographers, by photographers*. We know and understand your pain points - we’ve had them ourselves!

*And that’s why we built efpic.* 
...
Here’s why photographers choose efpic as their go-to photo proofing solution: 

- **1. Streamlined Client Experience:** With efpic, you can create a seamless client experience that sets you apart in the industry. Impress your clients with *proofing galleries*, *interactive feedback* options, and *efficient communication*.
- **2. Brand Reinforcement:** efpic Pro allows you to reinforce your brand identity. Add your custom logo and tailor the client gallery's appearance to match your unique branding, leaving a lasting impression.
- **3. Enhanced Client Interaction:** efpic Pro enables you to *receive detailed feedback from clients* by enabling them to leave comments for individual photos. Understand exactly what they want with their comments attached directly to the photo, so there’s no risk of any confusion later on.
...
- **6. Efficient Workflow:** efpic streamlines your workflow with the *import* feature, eliminating the need for manual uploads. Spend more time on what you do best – capturing stunning photos. And when ready, import photos in bulk.
- **7. Safeguard Your Images:** Protect your work from theft with efpic Pro's *watermarking* tool. Safeguard your images with watermarks, giving you peace of mind.
- **8. Multi-Client Proofing:** For photographers handling many clients, efpic Pro's support for multiple clients is a game-changer. Get feedback and approval of multiple client interactions efficiently, all on your WordPress site.
...
[Get Started with efpic Pro](https://efpic.io/pro/?utm_source=wordpress.org&utm_medium=readme)
...
Elevate your photography business with efpic – your all-in-one solution for professional online photo proofing with WordPress. 

= Requirements =
* PHP 7.4
* WordPress 6.0
= Website =
* [efpic.io](https://efpic.io/?mtm_campaign=wordpress.org&mtm_kwd=description)
= Authors =
...
1. Upload the `efpic` folder to your `/wp-content/plugins` directory.
2. Activate the "efpic" plugin in the WordPress administration interface.

== Frequently Asked Questions ==

= I have a problem. Where can I get help? =
Please take a look at our [documentation](https://efpic.io/docs/?utm_source=wordpress.org&utm_medium=readme) first. 
Still having issues? Check out the [support forum here on wp.org](https://wordpress.org/support/plugin/efpic/) or reach out via our [support page](https://efpic.io/support/?utm_source=wordpress.org&utm_medium=readme).

= Emails are not working =

**Can WordPress send emails?**

efpic uses functions built into WordPress to send emails. If you have any email issues, please make sure your WordPress installation can send emails, e.g., notifications for new comments, resetting passwords, etc. If those don’t work, efpic won’t be able to send emails either.
...
In case efpic emails end up in the client’s SPAM folder, ask them to add your  FROM address (no-reply@ + your domain name) to their allow list. You might also use the email options to change the FROM name and address. There are also [ filters](https://efpic.io/docs/developers/?utm_source=wordpress.org&utm_medium=readme#custom-from-name) to do this.
...
In 90% of cases this issue stems from using some kind of *optimization* or caching plugin. Please make sure to exclude efpic collections from any kind of optimization or caching in the respective plugin’s settings.

= efpic images show up in the Media Library =

By default, we hide all images in the Media Library. Sometimes, third party plugins *tamper* with the way image uploads are connected to their parent post. If that connection between image and collection is lost, efpic can’t filter its images from appearing in the library.

= efpic images do not show up in the Media Library =

This is intentional. 🙂 We wanted to separate the images that you use in a efpic collection from the images you use on your website, thereby keeping you from accidentally using an image from a collection in a blog post or in your portfolio.
...
efpic also cleans up behind itself: When you delete a collection, all images are deleted from the server automatically. (You can see how using an image elsewhere on the site would become a problem here.)

= More options are available via filters and action hooks =

There are lots of additional options to configure and extend efpic by using a little bit of code. To get started, have a look at our [developers page](https://efpic.io/docs/developers/?utm_source=wordpress.org&utm_medium=readme). Also, please have a look at our examples page with lots of [working code snippets](https://efpic.io/docs/developers/filter-examples/?utm_source=wordpress.org&utm_medium=readme).

= Can I help translate efpic into my language? =

Yes! efpic has been translated by our kind users into many different languages. If not available already, you can contribute translations by going to [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/efpic/). Choose your language, then click on "Stable (latest release)" and start adding translations. (Please note that you need a WordPress.org account to add translations.)

BTW: We are looking for people to help us [translate our Pro modules as well](https://efpic.io/docs/translating-efpic/?utm_source=wordpress.org&utm_medium=readme). If you are interested in a free license, [get in touch](mailto:info@efpic.io).

= I have an idea that would make efpic even better =

Awesome! We are always open to feature suggestions and are always interested to learn about photographers' workflows. Please [get in touch](mailto:info@efpic.io)!

== Screenshots ==

1. efpic in the WordPress Admin: Simply create a collection of photos and send it to your client.
...
* **Bugfix:** Fixed a bug where our efpic images exclusion from the media library could cause issues with third party plugins. (Thx Fabrice L.)
...
* **Added:** Compatibility with efpic Pro 2.5.0.

* **Updated:** efpic Pro 2.5.0 or higher is required for using efpic 3.5.0.

### 3.4.0
Release Date: 2026-02-09

* **Added:** The efpic [Collections List block](https://efpic.io/docs/how-to/collections-list-block/) is now available, which allows you to show clients a list of collections on any page or post. You can filter collections by date, status, current user (email address) and more.

* **Added:** Update [telemetry data scheme](https://efpic.io/docs/telemetry/#what-data-are-we-collecting) and include (anonymized) efpic Pro e-commerce data. Activating telemetry helps us understand real-world usage. More about [how we use telemetry](https://efpic.io/docs/telemetry/).

* **Updated:** efpic Pro 2.4.1 or higher is required for using efpic 3.4.0.

### 3.3.1
Release Date: 2025-11-20

* **Bugfix:** Made missing strings in the proof file translatable.

* **Added:** efpic Pro Black Friday notice

### 3.3.0
Release Date: 2025-10-31

* **Added:** Compatibility with efpic Pro 2.3.0.

### 3.2.0
Release Date: 2025-09-29

* **Updated:** The number of selected images are now shown in the proof txt file.

* **Updated:** Client facing download button styling has been updated.

* **Updated:** The Pro page is now much nicer and finally up to date.

* **Added:** Compatibility with efpic Pro 2.2.0.

### 3.1.0
Release Date: 2025-09-08

* **Added:** efpic now remembers original filenames. This ensures that filenames in the proof txt file (or when copy-and-pasting) can now contain spaces and other characters, which were previously sanitized (e.g., converted to dashes) during upload.

* **Added:** efpic now deletes unused collection images automatically. Before, uploaded images would remain on the server until the collection was deleted. Now unused images will be deleted when saving the collection.
...
* **Added:** Compatibility with efpic Pro 2.1.0.
...
* **Fixed:** We fixed a bug where efpic could send reminder emails even if the collection had already been approved.

* **Updated:** Made some under the hood changes to the way we update the filters on the front end.
...
* **Added:** Compatibility with efpic Pro 2.0.0, which adds [e-commerce integration](https://efpic.io/blog/from-proof-to-purchase)
...
* **Added:** Email formatting is now possible with Markdown. Check out [the docs](https://efpic.io/docs/how-to/formatting-email-text/) for details.
...
* **Added:** Compatibility with efpic Pro 1.5.0, which adds [star rating and filtering](https://efpic.io/pro/star-rating-and-filter/)

* **Added:** Client initials in the collection overview now link to the client's selection

* **Changed:** Updated WordPress.org assets including the efpic logo and the banner graphic

### 2.3.8
Release Date: 2024-08-31

* **Changed:** The "Show efpic logo" setting is now off by default to comply with wp.org guidelines.
...
* **Added:** As collections are not meant to be public, they were excluded from SEO from the begining. But collections were still visible in the Yoast settings (although those settings didn't do anything). [This has now been fixed.](https://log.efpic.dev/exclude-custom-post-type-from-yoast/)

* **Added:** Compatibility to efpic Pro 1.4.7
...
* **Changed:** Started disabling auto loading of efpic options.

* **Changed:** Improved styling of efpic UI in the WP Admin.

### 2.3.4
Release Date: 2024-07-11

* **Added:** When adding a client, after a collection has been published, it is now possible to also [enter their name](https://log.efpic.dev/improving-add-client/). Plus, you can now decide via a checkbox, if an email should be sent to the new client.
...
* Enhancements
  * Handle „private“ post status better, which is not supported with efpic collections
  * New and updated Pro banners, with more helpful links to our website
  * Compatibility with efpic Pro 1.4.4
...
* Bugfixes
  * efpic Pro compatibality update 
...
* Bugfixes
  ...
  * Fix positioning of admin notices on the efpic settings page
...
**Please note: efpic 2.0+ is only compatible with efpic Pro 1.1.0 and higher.** [Learn more](https://efpic.io/docs/efpic-2-update/)

* Enhancements
  * Compatibility with efpic Pro 1.2.0
...
**Please note: efpic 2.0.0 is only compatible with efpic Pro 1.1.0 and higher.** [Learn more](https://efpic.io/docs/efpic-2-update/)

* Enhancements
  * You can now set collections to expire
  * efpic can now automatically send emails to remind clients to make their final approval
  * New setting to automatically set a random password for a new collection
  * Refreshed settings pages

### Pre 2.0.0

Older changelog entries can be found [here](https://efpic.io/efpic-changelog/).