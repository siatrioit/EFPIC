<script id="efpic-registration" type="text/template">
	<div class="efpic-modal-inner efpic-modal-inner--narrow">
		<div class="efpic-registration-before">
			...
			<p><?php
				...
				if ( $email_required == 'on' ) {
					$registration_intro = __( 'Please enter your name and email address to start selecting images.', 'efpic' );
				}
				else {
					$registration_intro = __( 'Please enter your name to start selecting images.', 'efpic' );
				}
		...
		<?php
			...
			$output .= '<p>' . __( 'Please check your email inbox for your link to access the collection.', 'efpic' ) . '</p>';
