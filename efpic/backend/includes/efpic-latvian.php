...
function efpic_get_latvian_translations() {
	...
	$built = array(
		...
		'Email signature (added automatically)' => 'E-pasta paraksts (pievienojas automātiski)',
		'Edit in Settings' => 'Rediģēt iestatījumos',
		'This signature is appended to the email after your message. Do not write another signature above.' => 'Šis paraksts tiek pievienots e-pastam pēc tavas ziņas. Nekopē otru parakstu ziņas laukā.',
		"Dear Client,\n\nYour images are ready!\n\nYou can download them by following the link below." => "Cienījamais klient!\n\nTavas bildes ir gatavas!\n\nLejupielādē tās, izmantojot saiti zemāk.",
		"Dear Client,\n\nPlease select the photos you like and send your selection back to us. We will start post-production as soon as we have your approval." => "Cienījamais klient!\n\nLūdzu, atlasiet bildes, kas jums patīk, un atsūtiet atlasi mums. Kad būs apstiprinājums, sāksim pēcapstrādi.",
...
function efpic_latvian_translations_extra( $map ) {
	$extra = array(
		...
		'Deliver Final Images' => 'Nosūtīt bildes',
		'The collection is now closed.' => 'Kolekcija tagad ir aizvērta.',
		'The collection has already been closed.' => 'Kolekcija jau ir aizvērta.',
