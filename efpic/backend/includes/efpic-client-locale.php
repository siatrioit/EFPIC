...
function efpic_get_client_lv_translations() {
	...
	$pro = array(
		...
		'Your package includes %1$s images. Each additional image costs %2$s.' => 'Paketē iekļautas %1$s bildes. Katra papildu bilde maksā %2$s.',
		'In Price: %1$s / %2$s images' => 'Cenā: %1$s / %2$s bildes',
		'+%1$s extra images, additional cost: %2$s' => '+%1$s papildu bildes, papildus jāmaksā: %2$s',
		'Unselected' => 'Neatlasītas',
		'Reset filters' => 'Notīrīt filtrus',
		'Show Information about this collection' => 'Rādīt informāciju par šo galeriju',
		'saved' => 'saglabāts',
