...
function efpic_get_client_lv_translations() {
	...
	$pro = array(
		...
		'When using In Price, please enter the extra image cost.' => 'Izmantojot «Cenā iekļauts», norādiet papildu bildes cenu.',
		'Extra image cost must be zero or greater.' => 'Papildu bildes cenai jābūt nullei vai lielākai.',
		'Basic package includes preparation of %1$s images. Each additional image costs %2$s.' => 'Pamatpakalpojumā iekļauta %1$s bilžu sagatavošana. Katra papildu bilde maksā %2$s.',
		'Basic package includes preparation of %1$s images.' => 'Pamatpakalpojumā iekļauta %1$s bilžu sagatavošana.',
		'+%1$s extra image' => '+%1$s papildu bilde',
		'+%1$s extra images' => '+%1$s papildus bildes',
		'Additional payment due: Eur %1$s' => 'Papildus jāmaksā: Eur %1$s',
		'Images in gallery' => 'Bildes galerijā',
		'Extra processing' => 'Papildus apstrāde',
		'Extra payment' => 'Papildus samaksa',
		'Unselected' => 'Pārējās',
		'Reset filters' => 'Atiestatīt',
		'Show Information about this collection' => 'Informācija',
		'saved' => 'saglabāts',
